    ...
    render() {
        ...
        return (
            <div style={{marginLeft:"-8px"}}>
                ...
                <a className="resp-sharing-button__link" href={"https://facebook.com/sharer/sharer.php?u="+window.location.href} target="_blank" rel="noopener noreferrer" aria-label="">
                ...
                <a className="resp-sharing-button__link" href={"https://twitter.com/intent/tweet/?text="+title+";url="+window.location.href} target="_blank" rel="noopener noreferrer" aria-label="">
                ...
                <a className="resp-sharing-button__link" href={"https://pinterest.com/pin/create/button/?url="+window.location.href+"&amp;media="+window.location.href+"&amp;description="+title} target="_blank" rel="noopener noreferrer" aria-label="">
                ...
                <a className="resp-sharing-button__link" href={"https://www.linkedin.com/shareArticle?mini=true&amp;url="+window.location.href+"&amp;title="+title} target="_blank" rel="noopener noreferrer" aria-label="">
                ...
                <a className="resp-sharing-button__link" href={"whatsapp://send?text="+title} target="_blank" rel="noopener noreferrer" aria-label="">
